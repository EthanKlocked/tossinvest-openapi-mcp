...
export const toolDefinitions: ToolDefinition[] = [
  ...
  { name: 'portfolio_snapshot', description: 'Read a structured account snapshot: holdings, KRW/USD buying power, open orders, calculable position weights, warning flags, and partial failures.', schema: { accountSeq, currencies: z.array(z.enum(['KRW', 'USD'])).optional(), limit: z.number().int().min(1).max(100).optional() }, handler: portfolioSnapshot },
