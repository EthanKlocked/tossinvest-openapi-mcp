...
test('registers all requested read-only and trading tools', () => {
  ...
  assert.deepEqual(names, ['accounts', 'auth_status', 'buying_power', 'candles', 'commissions', 'exchange_rate', 'holdings', 'market_calendar', 'order_cancel', 'order_create', 'order_detail', 'order_modify', 'order_validate', 'orderbook', 'orders_closed', 'orders_open', 'price_limits', 'prices', 'sellable_quantity', 'stock_info', 'stock_warnings', 'trades'].sort());
});
